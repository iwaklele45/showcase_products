                    ...
                    <div class="card">
                        ...
                        <form action="{{ route('admin.users.update', $user) }}" method="POST">
                            ...
                            <div class="card-body">
                                ...
                                <div class="mb-3" id="storeFields" style="display: {{ old('role', $user->role) === 'seller' ? 'block' : 'none' }};">
                                    <hr>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <textarea class="form-control @error('store_description') is-invalid @enderror" 
                                                  id="store_description" name="store_description" rows="3">{{ old('store_description', $user->store_description) }}</textarea>
                                ...
                                <div class="form-check mb-3">
                                    <input class="form-check-input" type="checkbox" id="email_verified" 
                                           name="email_verified" {{ old('email_verified', $user->email_verified) ? 'checked' : '' }}>
